...
public class ActivityVisitorsSecAdapter  extends RecyclerView.Adapter<ActivityVisitorsSecAdapter.NotificationVH> implements Filterable {
    // public List<NotificationModel> NotificationModelArrayList;
    Context context;
    ActivityVisitorsSecResponseModel mResponse;
    public List<ActivityVisitorsSecResponseModel> preApprovedListResponseModelArrayList = new ArrayList<>();
    private Subscription mSubscription;
    private String TAG = "PreApprovedAdapter";
    private List<ActivityVisitorsSecResponseModel.Result> visitorsFilteredList;
    ...
    public ActivityVisitorsSecAdapter(Context context, ActivityVisitorsSecResponseModel mResponse) {
        this.context = context;
        this.mResponse = mResponse;
        this.visitorsFilteredList = mResponse.getResult();
        Log.i(TAG, "ActivityVisitorsSecAdapter: mresponse" + mResponse);
    }

    @NonNull
    @Override
    public ActivityVisitorsSecAdapter.NotificationVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.pre_approved_layout, parent, false);
        return new ActivityVisitorsSecAdapter.NotificationVH(itemView);

    }

    @Override
    public void onBindViewHolder(@NonNull ActivityVisitorsSecAdapter.NotificationVH holder, int position) {
...
//            String newstr = new SimpleDateFormat("MM/dd/yyyy, H:mm:ss").format(simpleDate);
//            String onlyDate = new SimpleDateFormat("MM/dd/yyyy").format(simpleDate);
...
//        }
        ...
        String MobileNumber = visitorsFilteredList.get(position).getMobile_number();
        ...
        String whomToMeet = visitorsFilteredList.get(position).getWhom_to_meet();
        ...
        String user_pic = visitorsFilteredList.get(position).getUser_pic();
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<ActivityVisitorsSecResponseModel.Result> filteredList = new ArrayList<>();
                    for (ActivityVisitorsSecResponseModel.Result row :  mResponse.getResult()) {
...
//                        }
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                visitorsFilteredList = (ArrayList<ActivityVisitorsSecResponseModel.Result>) filterResults.values;
...
//            intimeTV.setVisibility(View.INVISIBLE);
