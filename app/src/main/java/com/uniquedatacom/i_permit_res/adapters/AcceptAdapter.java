...
public class AcceptAdapter extends RecyclerView.Adapter<AcceptAdapter.NotificationVH> implements Filterable {
    // public List<NotificationModel> NotificationModelArrayList;
    Context context;
    EmpAcceptResponseModel mResponse;
    public List<EmpAcceptResponseModel> notificationResponseModelList = new ArrayList<>();
    private List<EmpAcceptResponseModel.Result> approvedFilteredList = new ArrayList<>();
    ...
    public AcceptAdapter(Context context, EmpAcceptResponseModel mResponse) {
        this.context = context;
    ...
    @NonNull
    @Override
    public AcceptAdapter.NotificationVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.pre_approved_layout,parent,false);
        return new AcceptAdapter.NotificationVH(itemView);

    }

    @Override
    public void onBindViewHolder(@NonNull AcceptAdapter.NotificationVH holder, int position) {
...
//         LoadImageFromUrl(context, "https://images-na.ssl-images-amazon.com/images/I/71IeYNcBYdL._SX569_.jpg",holder.profileimageIV);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<EmpAcceptResponseModel.Result> filteredList = new ArrayList<>();
                    for (EmpAcceptResponseModel.Result row :  mResponse.getResult()) {
...
//                        }
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                approvedFilteredList = (ArrayList<EmpAcceptResponseModel.Result>) filterResults.values;
